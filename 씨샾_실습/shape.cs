...
namespace ConsoleApplication11
{
    ...
    {
        private int shape_length { get; set; }
    }
    class Twodim : Shape
    {
        private double twodim_area { get; set; }
        private double twodim_perimeter { get; set; }
    }
    class Threedim : Shape
    {
        private double threedim_area { get; set; }
        private double threedim_volume { get; set; }
    }
